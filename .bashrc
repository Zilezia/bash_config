# TOOD maybe move all of this into a ~/.bash/cfg.sh and from here just call that?
...
__conda_setup="$('/home/zilezia/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/zilezia/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/zilezia/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/zilezia/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
